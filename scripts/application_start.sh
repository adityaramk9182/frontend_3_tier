...
sudo aws s3 cp s3://my-tf-kamisetty-bucket/app.js /var/www/html/
sudo aws s3 cp s3://my-tf-kamisetty-bucket/package.json /var/www/html/
sudo aws s3 cp s3://my-tf-kamisetty-bucket/package-lock.json /var/www/html/
sudo aws s3 cp --recursive s3://my-tf-kamisetty-bucket/node_modules /var/www/html/node_modules
